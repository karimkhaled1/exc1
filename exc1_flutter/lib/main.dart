...
import 'package:exc1_flutter/presentation/home/UI/home_screen.dart';
import 'package:flutter/material.dart';
import 'package:get_it/get_it.dart';

void main() {
  GetIt getIt = GetIt.instance;
  var peopleRepo = PeopleRepoImp(apiRepo: ApiRepo(), connectionChecker: ConnectivityService(), dbrepo: DbRepo());
  getIt.registerSingleton<ProductRepo>(peopleRepo);
  getIt.registerSingleton<ProductUseCase>(ProductUseCase(getIt.get<ProductRepo>()));
